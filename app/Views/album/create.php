...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Přidat album</li>
    </ol>
</nav>

<h1 class="h3 mb-4">Přidat album</h1>
...
<div class="card shadow-sm" style="max-width: 750px;">
    <div class="card-body">
        <form action="<?= base_url('album/store') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="description" name="description" rows="6"><?= esc(old('description')) ?></textarea>
            </div>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="<?= base_url('album') ?>" class="btn btn-outline-secondary">Zpět</a>
            </div>
        </form>
    </div>
</div>
